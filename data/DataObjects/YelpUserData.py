...
class YelpUser:
  ...
  '''
  Update Emotions. '''
  def update_food_emo(self, food, emo):
    if not self.food_emo.has_key(food):
      self.food_emo[food] = 0
    self.food_emo[food] += emo['posemo']
    self.food_emo[food] -= emo['negemo']
  ##
